...
export const adminAPI = {
  ...
  createSiteConnection: (data: SiteConnectionPayload) => api.post('/admin/site-connections', data),
  updateSiteConnection: (id: number, data: SiteConnectionPayload) => api.put(`/admin/site-connections/${id}`, data),
